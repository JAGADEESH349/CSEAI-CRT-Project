...
function AdminStats() {
  ...
  const barData = [
    { name: "Total", "Total Complaints": complaints.length, "Pending Complaints": 0, "Solved Complaints": 0 },
    { name: "Pending", "Total Complaints": 0, "Pending Complaints": pending.length, "Solved Complaints": 0 },
    { name: "Solved", "Total Complaints": 0, "Pending Complaints": 0, "Solved Complaints": solved.length },
  ];
    ...
    <div className="dashboard-page">
      <div className="admin-panel container-fluid">
        <div className="container mt-4">
          ...
          {/* Header */}
          <div className="police-header-bar mb-4">
              ...
              <div className="panel-card">
                ...
                <ResponsiveContainer width="100%" height={260}>
                  <BarChart data={barData} margin={{ top: 10, right: 10, left: -10, bottom: 0 }}>
                    ...
                    <Tooltip />
                    <Legend />
                    <Bar dataKey="Total Complaints" fill="#3B82F6" radius={[4,4,0,0]} />
                    <Bar dataKey="Pending Complaints" fill="#F59E0B" radius={[4,4,0,0]} />
                    <Bar dataKey="Solved Complaints" fill="#10B981" radius={[4,4,0,0]} />
                  </BarChart>
                </ResponsiveContainer>
              </div>
            </div>
