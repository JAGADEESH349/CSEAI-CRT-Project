        ...
        <div className="mc-modal-overlay" onClick={() => setViewingComplaint(null)}>
          <div className="mc-view-modal" onClick={e => e.stopPropagation()}>
            ...
            <div className="mc-view-footer">
              <button className="mc-view-close-btn" onClick={() => setViewingComplaint(null)}>
                Close
              </button>
            ...
            <div className="mc-edit-body">
              ...
              <div className="mc-edit-row">
                ...
                <div className="mc-edit-field">
                  ...
                  <input className="mc-edit-input" type="tel"
              ...
              <div className="mc-edit-field">
                ...
                <input className="mc-edit-input"
                  placeholder="Name or description of accused (if applicable)"
                  value={editForm.accusedName || ""}
                  onChange={e => setEditForm({...editForm, accusedName: e.target.value})}
                />
              </div>
              ...
              <div className="mc-edit-field">
                ...
                <textarea className="mc-edit-textarea mc-edit-textarea-sm"
              ...
              <div className="mc-edit-field">
                ...
                <textarea className="mc-edit-textarea mc-edit-textarea-sm"
                  placeholder="Witness name, contact, relationship..."
